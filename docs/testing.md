...
| File                         | Proves                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `secret-redaction.test.ts`   | 15 credential formats are removed; eleven real card numbers are redacted while evidence ids, task ids, UUIDs, timestamps and long numeric identifiers survive untouched, sampled over 5000 generated ids and 5000 timestamps against 5000 synthesised Visa numbers; redaction is idempotent and stable across calls; deep objects, cycles and depth bombs are handled |
