...
| File                         | Proves                                                                                                                                                                                                                                                                                                      |
| ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `secret-redaction.test.ts`   | 15 credential formats are removed; seven real card numbers are redacted while digit runs that fail the Luhn checksum are left intact; redaction is idempotent and stable across calls; deep objects, cycles and depth bombs are handled                                                                     |
